...
This is an attempt to learn about connectivity between windows and the serial port of my arduino UNO and a bit of the Windows audio stack. My objective is to documentate and demostrate the results of this project.

I'm building the entire project with Python and the ArduinoIDE to load the program in C++.  

# Changelog

## 5/22/26

Today I've started to check the 
